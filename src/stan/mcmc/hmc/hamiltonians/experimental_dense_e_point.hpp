#ifndef STAN_MCMC_HMC_HAMILTONIANS_EXPERIMENTAL_DENSE_E_POINT_HPP
#define STAN_MCMC_HMC_HAMILTONIANS_EXPERIMENTAL_DENSE_E_POINT_HPP
...
namespace stan {
  namespace mcmc {
     ...
     */
    class experimental_dense_e_point: public ps_point {
    public:
      /** 
       * Inverse mass matrix.
       */
       ...
       */
      experimental_dense_e_point(const experimental_dense_e_point& z)
