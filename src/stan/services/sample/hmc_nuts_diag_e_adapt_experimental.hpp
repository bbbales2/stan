#ifndef STAN_SERVICES_SAMPLE_HMC_NUTS_DIAG_E_ADAPT_EXPERIMENTAL_HPP
#define STAN_SERVICES_SAMPLE_HMC_NUTS_DIAG_E_ADAPT_EXPERIMENTAL_HPP
...
#include <stan/mcmc/hmc/nuts/adapt_experimental_diag_e_nuts.hpp>
...
namespace stan {
  namespace services {
    namespace sample {
      ...
      /**
       * Runs HMC with NUTS with experimental adaptation using diagonal Euclidean metric
