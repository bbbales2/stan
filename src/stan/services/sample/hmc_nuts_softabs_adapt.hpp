#ifndef STAN_SERVICES_SAMPLE_HMC_NUTS_SOFTABS_ADAPT_HPP
#define STAN_SERVICES_SAMPLE_HMC_NUTS_SOFTABS_ADAPT_HPP
...
namespace stan {
  namespace services {
    namespace sample {
      ...
      /**
       * Runs HMC with NUTS with adaptation using Softabs metric
      ...
      int hmc_nuts_softabs_adapt(Model& model, stan::io::var_context& init,
        ...
        stan::mcmc::adapt_softabs_nuts<Model, boost::ecuyer1988>
          sampler(model, rng);
      ...
      int hmc_nuts_softabs_adapt(Model& model, stan::io::var_context& init,
        ...
        return hmc_nuts_softabs_adapt(model, init, unit_e_metric,
