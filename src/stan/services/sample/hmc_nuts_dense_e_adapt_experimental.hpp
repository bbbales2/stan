#ifndef STAN_SERVICES_SAMPLE_HMC_NUTS_DENSE_E_ADAPT_EXPERIMENTAL_HPP
#define STAN_SERVICES_SAMPLE_HMC_NUTS_DENSE_E_ADAPT_EXPERIMENTAL_HPP
...
#include <stan/mcmc/hmc/nuts/adapt_experimental_dense_e_nuts.hpp>
