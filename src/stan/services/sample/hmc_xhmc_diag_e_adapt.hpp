#ifndef STAN_SERVICES_SAMPLE_HMC_XHMC_DIAG_E_ADAPT_HPP
#define STAN_SERVICES_SAMPLE_HMC_XHMC_DIAG_E_ADAPT_HPP
...
namespace stan {
  namespace services {
    namespace sample {
      /**
       * Runs HMC with XHMC with adaptation using diagonal Euclidean metric
       ...
       * @param[in] x_delta Exhaustian tolerance
      ...
      int hmc_xhmc_diag_e_adapt(Model& model, stan::io::var_context& init,
                                ...
                                double stepsize_jitter, int max_depth, double x_delta,
        ...
        stan::mcmc::adapt_diag_e_xhmc<Model, boost::ecuyer1988>
          sampler(model, rng);

        sampler.set_metric(inv_metric);
        sampler.set_x_delta(x_delta);
